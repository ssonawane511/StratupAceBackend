...
import loginMadal from "../../assets/images/loginMadal.gif";
//modal
...
const MentorProfile = () => {
  ...
  useEffect(() => {
    if (handle) {
      ...
      if (user) {
        Axios({
          method: "post",
          url: `/api/startups/checkRequest/${handle}`,
          data: {
            userId: user.uid,
          },
        }).then((res) => {
  ...
  const handleConnectionSubmit = (e) => {
    ...
    Axios({
      method: "post",
      url: `/api/startups/connection/${handle}`,
      data: {
        userId: user.uid,
        note: requestNote,
      },
                    ...
                    {requestSendSuccess ? (
                      ...
                      <div className='col'>
                        ...
                        <form onSubmit={handleConnectionSubmit}>
                          <textarea
                            className='form-control requetNote'
                            rows='4'
                            onChange={(e) =>
                    ...
                    <div className='col-4 '>
                      <div className='profile-block primay-block'>
                        ...
                        <div className='icon-text '>
                          ...
                          <p>
                            <strong>
                              {details.MentorDetails.industryType}
                            </strong>
                          </p>
                        </div>
                      </div>
